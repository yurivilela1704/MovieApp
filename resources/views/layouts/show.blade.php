                ...
                @if (count($movieDetail['videos']['results']) > 0)
                    <div class="mt-12">
                        <a href="https://www.youtube.com/watch?v={{  $movieDetail['videos']['results'][0]['key']}}">
                            <button class="flex inline-flex items-center bg-yellow-500 text-gray-800 rounded font-semibold
                            py-4 px-4 hover:bg-yellow-300 transition ease-in-out duration-150">
